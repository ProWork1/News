                ...
                <Nav className='navbar navbar-expand-lg navbar-light'>
                    <div className='d-flex justify-content-between align-items-center navbar-top'>
                        ...
                        <div className='d-flex'>
                            ...
                            <ul className='social-media'>
                                <li>
                                    <a href='/'>
                                        <Icon icon='mdi:instagram' className='i' />
                                    </a>
                                </li>
                                <li>
                                    <a href='/'>
                                        <Icon icon='mdi:facebook' className='i' />
                                    </a>
                                </li>
                                <li>
                                    <a href='/'>
                                        <Icon icon='mdi:youtube' className='i' />
                                    </a>
                                </li>
                                <li>
                                    <a href='/'>
                                        <Icon icon='mdi:linkedin' className='i' />
                                    </a>
                                </li>
                                <li>
                                    <a href='/'>
                                        <Icon icon='mdi:twitter' className='i' />
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className='navbar-bottom-menu'>
                        ...
                        >
                            <Nav
                                navbar
                                className='position-relative d-lg-flex justify-content-between align-items-center'
                            >
                                <NavItem>
